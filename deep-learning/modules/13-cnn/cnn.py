...
def receptive_field(num_conv_layers: int, kernel_size: int) -> int:
    ...
    """
    raise NotImplementedError(
        "TODO: примени формулу RF = 1 + (kernel_size - 1) * num_conv_layers"
    )
...
def augment_batch(
    ...
    """
    raise NotImplementedError(
        "TODO: создай rng с seed; для каждой картинки: (a) flip с p=0.5, "
        "(b) reflect-pad + случайный кроп, (c) добавь гауссов шум noise_std*randn"
    )
