...
def train_regularized(
    ...
    """
    raise NotImplementedError("TODO: собери цикл эпох: dropout→grad+L2→eval→чекпоинт→ранняя остановка")
...
def confusion_counts(y_true: np.ndarray, y_pred: np.ndarray) -> Tuple[int, int, int, int]:
    ...
    """
    raise NotImplementedError("TODO: посчитай tp/fp/fn/tn через булеву индексацию массивов y_true и y_pred")
...
def precision_recall_f1(y_true: np.ndarray, y_pred: np.ndarray) -> Tuple[float, float, float]:
    ...
    """
    raise NotImplementedError("TODO: вызови confusion_counts, затем посчитай P/R/F1 с обработкой деления на ноль")
