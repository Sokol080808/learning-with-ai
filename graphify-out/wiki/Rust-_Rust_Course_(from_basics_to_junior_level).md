...
- **Rust Course (from basics to junior level)** (5 connections) — `rust/README.md`
- **Deep Learning Course (math to your own transformer)** (3 connections) — `deep-learning/README.md`
- **Rationale: whole-workspace graphify rule (query/path/explain first; regen only on main)** (2 connections) — `CLAUDE.md`
