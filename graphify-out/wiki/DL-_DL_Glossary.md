...
- **Regularization** (2 connections) — `deep-learning/GLOSSARY.md`
- **ReLU** (1 connections) — `deep-learning/GLOSSARY.md`
- **RNN (recurrent network)** (1 connections) — `deep-learning/GLOSSARY.md`
