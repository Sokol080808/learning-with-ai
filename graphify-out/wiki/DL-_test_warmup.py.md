...
- **Среднее арифметическое всех элементов массива как питоновский float.      Контра** (1 connections) — `deep-learning/modules/00-setup/warmup.py`
...
- `deep-learning/modules/00-setup/test_warmup.py`
- `deep-learning/modules/00-setup/warmup.py`
