...
- **execute()** (35 connections) — `python/capstone/tasks/commands.py`
...
- [[Python: TaskStore]] (3 shared connections)

## Source Files

- `python/capstone/tasks/__init__.py`
- `python/capstone/tasks/commands.py`
- `python/capstone/tasks/store.py`
- `python/capstone/tests/test_commands.py`
