...
- **test_gradients.py** (13 connections) — `deep-learning/modules/03-gradients/test_gradients.py`
- **grad_sum_squares()** (7 connections) — `deep-learning/modules/03-gradients/gradients.py`
- **grad_of_affine()** (6 connections) — `deep-learning/modules/03-gradients/gradients.py`
...
- `deep-learning/modules/03-gradients/gradients.py`
- `deep-learning/modules/03-gradients/test_gradients.py`
