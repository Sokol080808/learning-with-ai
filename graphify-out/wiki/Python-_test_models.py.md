...
- **test_models.py** (15 connections) — `python/modules/07-dataclasses-protocols/test_models.py`
...
- **Площадь фигуры. В базовом классе не определена — переопредели в наследнике.** (1 connections) — `python/modules/07-dataclasses-protocols/models.py`
- **Круг радиуса r. area() = math.pi * r ** 2.** (1 connections) — `python/modules/07-dataclasses-protocols/models.py`
- **Сохрани радиус в self.r.** (1 connections) — `python/modules/07-dataclasses-protocols/models.py`
- **Площадь круга: π * r^2 (используй math.pi).** (1 connections) — `python/modules/07-dataclasses-protocols/models.py`
- **Прямоугольник ширины w и высоты h. area() = w * h.** (1 connections) — `python/modules/07-dataclasses-protocols/models.py`
...
- `python/modules/07-dataclasses-protocols/models.py`
- `python/modules/07-dataclasses-protocols/test_models.py`
