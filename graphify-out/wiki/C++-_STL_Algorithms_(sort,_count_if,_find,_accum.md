...
- **STL Algorithms (sort, count_if, find, accumulate, transform, copy_if)** (7 connections) — `cpp/modules/08-stl/README.md`
- **STL Containers (vector, array, map, unordered_map, set, deque, list)** (6 connections) — `cpp/modules/08-stl/README.md`
- **Module 13 — Data Structures, Algorithms and Complexity** (6 connections) — `cpp/modules/13-data-structures/README.md`
- **Module 08 — STL: Containers, Iterators, Algorithms, Lambdas** (5 connections) — `cpp/modules/08-stl/README.md`
- **Module 10 — Modern C++ Idioms** (5 connections) — `cpp/modules/10-modern-idioms/README.md`
- **Module 11 — Multi-file Projects, Libraries and CMake** (5 connections) — `cpp/modules/11-projects/README.md`
- **Iterators (begin/end, [begin, end) range)** (3 connections) — `cpp/modules/08-stl/README.md`
- **Ranges / Views (C++20 pipelines, filter, transform)** (3 connections) — `cpp/modules/10-modern-idioms/README.md`
- **geometry Library Micro-Project (Point, distance, perimeter)** (3 connections) — `cpp/modules/11-projects/README.md`
- **Hash Table (unordered_map/set, O(1) average)** (3 connections) — `cpp/modules/13-data-structures/README.md`
- **two_sum (O(n) via hash map)** (3 connections) — `cpp/modules/13-data-structures/README.md`
...
- `cpp/modules/08-stl/README.md`
- `cpp/modules/10-modern-idioms/README.md`
- `cpp/modules/11-projects/README.md`
- `cpp/modules/13-data-structures/README.md`
