...
- **Module 05 - Copy, Move, Rule of 0/3/5** (9 connections) — `cpp/modules/05-copy-move/README.md`
- **RAII (constructor acquires, destructor releases)** (4 connections) — `cpp/modules/04-classes/README.md`
...
- [[C++: Module 06 - Smart Pointers and Ownership]] (3 shared connections)
