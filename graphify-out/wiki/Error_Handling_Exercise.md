...
- **TEST()** (11 connections) — `cpp/modules/09-error-handling/tests/test_task09.cpp`
- **task09.cpp** (5 connections) — `cpp/modules/09-error-handling/src/task09.cpp`
- **first_even()** (4 connections) — `cpp/modules/09-error-handling/src/task09.cpp`
...
- **element_at()** (3 connections) — `cpp/modules/09-error-handling/src/task09.cpp`
...
- **safe_divide()** (2 connections) — `cpp/modules/09-error-handling/src/task09.cpp`
