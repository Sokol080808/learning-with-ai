...
This project has a knowledge graph at graphify-out/ covering the **whole workspace** — all course tracks (`cpp/`, `python/`, `rust/`, `deep-learning/`) and root docs — with god nodes, community structure, and cross-file/cross-course relationships.
