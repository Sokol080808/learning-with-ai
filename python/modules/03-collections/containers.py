...
def split_head_tail(xs: list) -> tuple:
    ...
    Краевые случаи:
      ...
      [x,..] -> (x, [...])
    """
    raise NotImplementedError("TODO: обработай пустой список отдельно; для непустого используй starred-распаковку head, *tail = xs")
...
def sort_by_length(words: list[str]) -> list[str]:
    ...
    """
    raise NotImplementedError("TODO: используй sorted() с key=len — он стабильный по умолчанию")
